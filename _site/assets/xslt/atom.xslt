...
<xsl:template match="/atom:feed">
  ...
  <noscript>
	...
	<link type="text/plain" rel="author" href="http://localhost:4000/humansv2.txt" />
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=UA-107704339-1"></script>
		<script>
			window.dataLayer = window.dataLayer || [];
			function gtag(){dataLayer.push(arguments);}
			gtag('js', new Date());
			
			gtag('config', 'UA-107704339-1');
		</script>
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> IEEE Cluster 2018</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a href="http://localhost:4000/technical">Organizers</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://localhost:4000/authors">Program</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://localhost:4000/sponsors">Contacts</a></li>
              <li class="divider"></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000" title="IEEE Cluster 2018 – International Conference on Cluster Computing">
				<img src="http://localhost:4000/assets/img/logo.png" alt="IEEE Cluster 2018 – International Conference on Cluster Computing">
			</a>
